...
//     feedbackIngester/internal/config/config.go file.
//   - Application should have a directory holding default file and environment
//     specific file. E.g. refer feedbackIngester/configs/* directory.
//
// Usage:
...
func (c *Config) loadByConfigName(configName string, config interface{}) error {
	c.viper.SetEnvPrefix(strings.ToUpper("feedback_ingester"))
